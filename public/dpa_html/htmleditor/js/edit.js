...
{
	if (!WBTB_validateMode()) return;
	var arr = showModalDialog("wbTextBox/selcolor.htm", "", "dialogWidth:18.5em; dialogHeight:17.5em; status:0; help:0");
...
{
	if (!WBTB_validateMode())	return;
	var arr = showModalDialog("wbTextBox/table.htm", "", "dialogWidth:14.5em; dialogHeight:16.5em; status:0; help:0");
...
{
	var arr = showModalDialog("wbTextBox/replace.htm", "", "dialogWidth:16.5em; dialogHeight:13em; status:0; help:0");
