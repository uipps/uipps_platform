...
*/
$base_date_path = ''; //date("Y/m/d/");
if ('WIN' === strtoupper(substr(PHP_OS, 0, 3))) {
    $baseUrl = 'http://img3.wanda.cn/ckfinder/userfiles/' . $base_date_path;
    $baseDir = 'D:/www/img3.wanda.cn/ckfinder/userfiles/' . $base_date_path;
} else {
    $baseUrl = GetCurrentUrlPre() . '/upload/userfiles/' . $base_date_path;
    //$baseDir = '/var/wd/wrs/webroot/cms/upload/userfiles/' . $base_date_path;
    $baseDir = '/data0/htdocs/admin/dpa_html/ckeditor/ckfinder/userfiles/';
}
